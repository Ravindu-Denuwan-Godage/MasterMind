...
<body>
     <form action="login.php" method="post">
     	...
     	<input type="text" name="uname" placeholder="Username is level_4"><br>
		...
		<button type="button" name="homeButton" onclick="location.href='../helpPages/DictionaryAttack/index.php';">Stuck? Let's Talk</button>
     </form>
